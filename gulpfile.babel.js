...
gulp.task('dev', gulp.series(stylesDev,scriptsDev,pugDev,imagesDev,assets,tsTask,(done)=>{
  if (!wordPress){
    server.init({
      server: {
        baseDir: './public'
...
gulp.task('build', gulp.series(stylesBuild,pugBuild,scriptsBuild,imagesBuild,assets,cache,sitemapTask,robotsTask, tsTask))
